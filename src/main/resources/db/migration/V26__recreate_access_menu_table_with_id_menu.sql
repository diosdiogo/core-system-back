-- Drop da tabela access_menu existente
DROP TABLE IF EXISTS access_menu CASCADE;

-- Recriar tabela access_menu com id_menu na posição correta
...
COMMENT ON COLUMN access_menu.id_menu IS 'Referência para o menu (FK para menu.id)';
...
ALTER TABLE access_menu 
ADD CONSTRAINT fk_access_menu_menu 
...
UNIQUE (id_app_company, id_menu, id_perfil); 